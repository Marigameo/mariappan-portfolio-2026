...
export function HeroVideoDialog({
    ...
    return (
        <div className={cn("relative", className)}>
            ...
            >
                <div className="aspect-video overflow-hidden rounded-md border shadow-lg">
                    <img
                        src={thumbnailSrc}
                        alt={thumbnailAlt}
                        loading="lazy"
                ...
                <div className="absolute inset-0 flex scale-[0.9] items-center justify-center rounded-2xl transition-all duration-200 ease-out group-hover:scale-100">
                    <div className="bg-primary/10 flex size-20 items-center justify-center rounded-full backdrop-blur-md">
                        <div
                            className="from-primary/30 to-primary relative flex size-14 scale-100 items-center justify-center rounded-full bg-gradient-to-b shadow-md transition-all duration-200 ease-out group-hover:scale-[1.2]"
                        >
                            <Play
